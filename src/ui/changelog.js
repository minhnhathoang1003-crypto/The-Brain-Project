...
const CHANGELOG=[
  {v:"0.7.8", items:[
    ...
    "<b>Đường cài tiện ích ngắn lại còn hai bước</b> khi có link cửa hàng: bấm cài, dán mã ghép nối. Hết. Hướng dẫn nạp thủ công (Developer mode → Load unpacked) vẫn còn nguyên cho người chạy từ mã nguồn, chỉ gập lại. Chưa điền link thì không có gì đổi — không bao giờ hiện một nút trỏ vào chỗ chưa chắc có.",
