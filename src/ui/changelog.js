...
const CHANGELOG=[
  {v:"0.8.0", items:[
    ...
    "<b>Một thanh tiêu đề thay vì hai.</b> Trước đây thanh của Windows và thanh của ứng dụng chồng lên nhau, cùng hiện logo và tên, chiếm mất gần 90 điểm ảnh chiều cao cho phần trang trí. Ba nút thu nhỏ, phóng to, đóng vẫn do chính Windows vẽ như mọi ứng dụng khác.",
    "<b>Ba phím tắt:</b> <code>Ctrl+,</code> mở Cài đặt, <code>Ctrl+Shift+T</code> mở Thống kê, <code>Esc</code> đóng hộp thoại. Phím được ghi ngay trong chú thích của nút tương ứng.",
    "<b>Bấm chuột phải vào một mục bị chặn</b> để mở nhanh, kết thúc lượt mở, hoặc bỏ chặn. Menu do Windows vẽ, không phải hộp giả trong ứng dụng.",
    "<b>Đi bằng bàn phím thấy rõ mình đang ở đâu.</b> Trước đây gần như không có viền báo vị trí; nay mọi thứ bấm được đều có.",
    "<b>Sửa: cửa sổ nửa màn hình bị cắt ngang.</b> Kéo ứng dụng về nửa màn hình thì hai cột xếp chồng nhau nhưng mỗi cột lại tự cuộn riêng, cắt đôi nội dung đúng chỗ giáp ranh. Nay cuộn liền một mạch.",
    "<b>Cửa sổ rất rộng không kéo dài chữ hết cỡ nữa,</b> và cửa sổ hẹp thì nhãn trạng thái thu gọn về một chấm — nội dung đầy đủ vẫn còn khi rê chuột.",
  ]},
  {v:"0.7.9", items:[
  ...
  {v:"0.7.8", items:[
    ...
    "<b>Ứng dụng biết tiện ích của bạn là bản nào.</b> Tiện ích tự khai phiên bản khi ghép nối, và ⚙ → Bộ chặn hiện nó ra. Trước đây ứng dụng chỉ thấy \"đã kết nối\" — đúng cái lỗ hổng khiến bản trên Chrome Web Store kẹt ở 0.6.0 suốt mà không ai phát hiện. Tiện ích cũ hơn vẫn chặn đúng và vẫn giữ hạn chế độ khóa; ứng dụng nói rõ cái gì còn chạy chứ không chỉ cái gì hỏng.",
    "<b>Tiện ích đã lên Chrome Web Store, và đường cài ngắn lại còn hai bước:</b> bấm <b>Cài tiện ích</b>, dán mã ghép nối. Hết. Không còn Developer mode, không còn Load unpacked, không còn dòng \"Tắt tiện ích ở chế độ nhà phát triển\" mỗi lần mở Chrome. Cách nạp thủ công vẫn còn nguyên cho người chạy từ mã nguồn — chỉ gập lại một dòng.",
    "<b>Gói tiện ích nhẹ đi 26KB.</b> Trang chặn đóng gói sẵn ba subset font, trong đó <code>latin-ext</code> 85KB không có một ký tự nào thuộc riêng nó — mà vẫn thắng quyền vẽ chữ Việt, chỉ vì được khai sau. Bỏ đi: 114KB còn 88KB, chữ không đổi một nét.",
    "<b>README nói đúng lại.</b> Ba câu đã sai từ lâu: \"ứng dụng lưu 180 ngày\" (từ 0.7.6 nó không xoá lịch sử nữa), \"không cập nhật tự động\" (có từ 0.7.0), và \"chưa chặn ứng dụng Windows\" (có từ 0.5.0). Thêm một bảng nói thẳng bộ chặn với tới đâu và không với tới đâu.",
  ]},
  {v:"0.7.7", items:[
